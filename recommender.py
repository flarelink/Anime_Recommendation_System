##############################################################################
# recommender.py - Anime recommendation system - updated with all animes up
#                  until 12/21/19.
#
...
from utils import scrape_image_url, scrape_user_data_from_username
...
def content_based(args):
    ...
    :return: (list of str, list of str) recommendations list and image references list
    """
